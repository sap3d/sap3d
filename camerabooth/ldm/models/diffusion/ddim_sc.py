...
class DDIMSampler(object):
    ...
    def sample(self,
        ...
        samples, intermediates = self.ddim_sampling(conditionings, size,
                                                    callback=callback,
    ...
    @torch.no_grad()
    def ddim_sampling(self, conds, shape,
        ...
        iterator = tqdm(time_range, desc=f"Running DDIM Sampling with {total_steps} timesteps", total=total_steps, leave=False)
