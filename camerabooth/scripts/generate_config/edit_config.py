...
if __name__ == "__main__":
    ...
    if opt.em7:
        config_data["data"]["params"]["objaverse_path"] = "/old_home_that_will_be_deleted_at_some_point/xinyang/threetothreed/dataset/data/objaverse"
    else:
        config_data["data"]["params"]["objaverse_path"] = "/shared/xinyang/threetothreed/dataset/data/objaverse"
