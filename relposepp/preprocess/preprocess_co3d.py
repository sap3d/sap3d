...
Usage:
    python -m preprocess.preprocess_co3d --category all --precompute_bbox --co3d_dir /shared/group/co3d --output_dir data/co3d
    python -m preprocess.preprocess_co3d --category all \--co3d_dir /shared/group/co3d --output_dir data/co3d
"""
import argparse
import gzip
import json
...
def get_parser():
    ...
    parser.add_argument("--co3d_dir", type=str, default="data/co3d_v2")
    parser.add_argument(
        "--min_quality",
        type=float,
        default=0.5,
