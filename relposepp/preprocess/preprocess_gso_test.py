...
def get_configures():
    ...
    parser.add_argument('--input_path', type=str, default='../dataset/data/train/ANGJOO/')
...
if __name__ == '__main__':
    ...
    for view_release_path in tqdm.tqdm(view_release_paths):
        ...
        #     test_dict[view_cls] = [0, 1, 2]

    # # * for test coordinate right or not
    # gso_paths = (
    #     [
    #         f'../dataset/data/GSO/test/{i}' for i in sorted(os.listdir('../dataset/data/GSO/test'))
    #     ] + \
    #     [
    #         f'../dataset/data/GSO_add/test/{i}' for i in sorted(os.listdir('../dataset/data/GSO_add/test'))
    #     ]
    # )
    ...
    #     view_data = []
    #     image_png_paths = [
    #         f'{gso_path}/images/{i:03d}.png' for i in range(84)
    #     ]
    #     pose_npy_paths = [
    #         f'{gso_path}/poses/{i:03d}.npy' for i in range(84)
    #     ]
    ...
    # gso_paths = (
    #     [
    #         f'../dataset/data/all_demo/ABO_demo/{i}' for i in sorted(os.listdir('../dataset/data/all_demo/ABO_demo'))
    #     ]
    # )
    # for gso_path in tqdm.tqdm(gso_paths):
    #     view_cls = gso_path.split('/')[-1]
    #     view_data = []
    #     image_png_paths = [
    #         f'{gso_path}/images/{i:03d}.png' for i in range(21)
    #     ]
    #     pose_npy_paths = [
    #         f'{gso_path}/poses/{i:03d}.npy' for i in range(21)
    #     ]
    ...
    # with open(f'{args.output_path}/gso_test.json', mode='w') as f:
    #     json.dump(test_dict, f, indent=2) 

    # output_file = f'{args.output_path}/gso_test.jgz'
