...
CUDA_VISIBLE_DEVICES=${GPU_ID} /home/xinyang/miniconda3/envs/sap3d/bin/python launch.py --train \
                                                                                    ...
                                                                                    data.default_elevation_deg=30.20257568359375 \
                                                                                    data.default_azimuth_deg=0.0 \
                                                                                    data.default_camera_distance=3.8 \
                                                                                    data.multiple_image_folder=../../dataset/data/train/GSO_add/GARDEN_SWING \
                                                                                    data.estimate_pose_path=../../camerabooth/experiments_GSO_add_view_3/GARDEN_SWING/2024-02-22T23-03-32_config_GARDEN_SWING_view_3-1-1000-1e-06-0.1-1e-07/evaluation/epoch_99/results.tar \
                                                                                    ...
                                                                                    name=GARDEN_SWING_ours \
                                                                                    system.is_gso=True \
                                                                                    system.guidance.guidance_scale=5.0 \
                                                                                    system.guidance.pretrained_model_name_or_path=../../camerabooth/experiments_GSO_add_view_3/GARDEN_SWING/2024-02-22T23-03-32_config_GARDEN_SWING_view_3-1-1000-1e-06-0.1-1e-07/checkpoints/last.ckpt \
                                                                                    system.guidance.use_sc_sds=True \
                                                                                    system.guidance.cond_view=1 \
                                                                                    system.guidance.cond_image_folder=../../dataset/data/train/GSO_add/GARDEN_SWING \
                                                                                    system.guidance.estimate_pose_path=../../camerabooth/experiments_GSO_add_view_3/GARDEN_SWING/2024-02-22T23-03-32_config_GARDEN_SWING_view_3-1-1000-1e-06-0.1-1e-07/evaluation/epoch_99/results.tar \
