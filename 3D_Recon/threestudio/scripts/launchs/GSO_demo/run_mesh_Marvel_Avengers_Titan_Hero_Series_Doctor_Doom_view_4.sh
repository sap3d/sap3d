#!/usr/bin/bash
    ...
    CUDA_VISIBLE_DEVICES=${GPU_ID} /home/xinyang/miniconda3/envs/sap3d/bin/python launch.py --export \
                                                    ...
                                                    --gpu 0 \
                                                    resume="experiments_GSO_demo_view_4_nerf/Marvel_Avengers_Titan_Hero_Series_Doctor_Doom_ours/[64, 128, 256]_000.png_prog0@20240216-002735/ckpts/last.ckpt" \
                                                    system.guidance.pretrained_model_name_or_path="experiments_GSO_demo_view_4_nerf/Marvel_Avengers_Titan_Hero_Series_Doctor_Doom_ours/[64, 128, 256]_000.png_prog0@20240216-002735/ckpts/last.ckpt" \
