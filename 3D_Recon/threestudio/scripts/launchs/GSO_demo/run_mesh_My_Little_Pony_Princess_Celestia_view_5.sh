#!/usr/bin/bash
    ...
    CUDA_VISIBLE_DEVICES=${GPU_ID} /home/xinyang/miniconda3/envs/sap3d/bin/python launch.py --export \
                                                    ...
                                                    --gpu 0 \
                                                    resume="experiments_GSO_demo_view_5_nerf/My_Little_Pony_Princess_Celestia_ours/[64, 128, 256]_000.png_prog0@20240215-202240/ckpts/last.ckpt" \
                                                    system.guidance.pretrained_model_name_or_path="experiments_GSO_demo_view_5_nerf/My_Little_Pony_Princess_Celestia_ours/[64, 128, 256]_000.png_prog0@20240215-202240/ckpts/last.ckpt" \
