...
${SAP3D_PYTHON_PATH} eval_mesh.py --target_res experiments_GSO_demo_mesh_view_${OBJECT_VIEW}

# 6. Calculate Pose Error
echo '######### Pose Eval #########'
cd ${ROOT_DIR}/camerabooth
${SAP3D_PYTHON_PATH} scripts/generate_summary/summary_experiments.py --object_type ${OBJECT_TYPE} --train_view ${OBJECT_VIEW}
